 ...
 * @version 10.8.0
 *
 * Giovanni's override: core verbatim apart from the two marked blocks, which give the
 * warehouse order email its four columns. The row markup lives in emails/email-order-items.php.
 */
	...
	<table class="td font-family <?php echo esc_attr( $order_table_class ); ?>" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
		...
		<thead>
			<tr>
				...
				<?php else : ?>
				<?php // Giovanni's warehouse columns. ?>
				<th class="td text-align-left" scope="col"><?php esc_html_e( 'ITEM # / SKU:', 'sage-roi-theme' ); ?></th>
				<th class="td text-align-left" scope="col"><?php esc_html_e( 'DESCRIPTION', 'sage-roi-theme' ); ?></th>
				<th class="td text-align-left" scope="col"><?php esc_html_e( 'AVERAGE ON HAND', 'sage-roi-theme' ); ?></th>
				<th class="td text-align-left" scope="col"><?php esc_html_e( 'SOLD BY', 'sage-roi-theme' ); ?></th>
				<?php endif; ?>
			</tr>
		</thead>
		<?php endif; ?>
		<tbody>
			...
			echo wc_get_email_order_items( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				...
				array(
					...
					// Giovanni's: the description column carries the thumbnail in both layouts.
					'show_image'    => true,
